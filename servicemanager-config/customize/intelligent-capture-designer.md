...
![Branch Form](/_books/servicemanager-config/customize/images/decision-node.png)
...
#### Example
Following the use of the Services Details form, you may include a decision node and have two outcomes:
