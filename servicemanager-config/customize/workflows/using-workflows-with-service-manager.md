...
You create workflow definitions in the [Workflow Designer](/esp-config/automation/workflow-designer). Each workflow definition includes:
...
Hornbill provides [a set of workflow utilities](https://www.hornbill.com/hubfs/LMS/Course-Resources/Live%20-%20Workflow%20automation/Hornbill%20Workflow%20Utilities.pdf) that you can use to facilitate date-related functions as well as operations to convert and manipulate data.
