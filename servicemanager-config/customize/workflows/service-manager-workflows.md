...
* **Source**.
* **Status**. Update the status to New, Open, On-hold, Resolved, Closed, or Cancelled.  Setting a request to Cancelled will also cancel the workflow and the workflow will not continue past this point.
* **Timeline**.
