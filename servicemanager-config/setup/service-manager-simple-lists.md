...
|CancelationReasons|This list supplies the Cancelation reasons that are available when a request is canceled using the corresponding "Cancel" request action button. Items can be added or removed from this list to suit your requirements.|
