...
* The Problem Management Team can use the workflow engine to automatically keep Affected Connections informed of progress or on the resolution of the issue via email.
